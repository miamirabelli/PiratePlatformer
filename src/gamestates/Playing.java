...
public class Playing extends State implements StateMethods {
	...
	private int leftBorder = (int) (0.2 * Game.GAME_WIDTH); // 20% of window
	private int rightBorder = (int) (0.8 * Game.GAME_WIDTH); // 20% of window
	...
	private void drawClouds(Graphics g) { // moving effect comes from xLvlOffset variable
