...
public class Constants {
	...
	public static class UI {
		...
		public static class Buttons {
			public static final int B_WIDTH_DEFAULT = 140; // 140 pixels
			public static final int B_HEIGHT_DEFAULT = 56; // 56 pixels
		...
		public static class PauseButtons {
			public static final int SOUND_SIZE_DEFAULT = 42; // 42 pixels
			public static final int SOUND_SIZE = (int) (SOUND_SIZE_DEFAULT * Game.SCALE);
		}
		
		public static class UrmButtons {
			public static final int URM_DEFAULT_SIZE = 56; // 56 pixels
